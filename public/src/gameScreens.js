...
export class startScreen extends Phaser.Scene{
    ...
    preload(){
        this.load.spritesheet('plunder', 'plunder.png', {
            frameWidth: 300,
            frameHeight: 200
        });
        this.load.spritesheet('plunderPress', 'plunderpress.png', {
            frameWidth: 300,
            frameHeight: 200
        });
        this.load.audio('titleMusic', 'startScreenSciFi.mp3');
        this.load.image("title", "clickTitle.png");

        this.load.audio('clickMusic', 'clickGameSummer.mp3');
        this.load.audio('clicked', 'click.mp3');
        this.load.audio('death', 'death.mp3');
        this.load.audio('jump','jump.wav');
        this.load.audio("runBGM", "runnerGameExtreme.mp3")
...
export class transitionScreen extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.spritesheet('runPress', 'runpress.png', {
            frameWidth: 300,
            frameHeight: 200
        });
    }
...
export class endScreen extends Phaser.Scene{
    ...
    preload(){
        this.load.spritesheet('again', 'pagain.png', {
            frameWidth: 300,
            frameHeight: 200
        });
        this.load.spritesheet('againPress', 'pagainpress.png', {
            frameWidth: 300,
            frameHeight: 200
        });
        this.load.spritesheet('quit', 'quit.png', {
            frameWidth: 300,
            frameHeight: 200
        });
        this.load.spritesheet('quitPress', 'quitpress.png', {
            frameWidth: 300,
            frameHeight: 200
        });
    }
