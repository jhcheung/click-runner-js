...
class clickGame extends Phaser.Scene{
    ...
    preload() {
        ...
        this.load.image('coins', 'coinbackgrounds.png');
       
        this.load.spritesheet("ruby", "ruby-sheet.png", {
            frameWidth: 64,
            frameHeight: 64
        });
        this.load.spritesheet("diamond", "diamond-sheet.png", {
            frameWidth: 64,
            frameHeight: 64
        });
        this.load.spritesheet("sapphire", "sapphire-sheet.png", {
            frameWidth: 64,
            frameHeight: 64
        });
        this.load.spritesheet("emerald", "emerald-sheet.png", {
            frameWidth: 64,
            frameHeight: 64
        });
        this.load.spritesheet("amethyst", "amethyst-sheet.png", {
            frameWidth: 64,
            frameHeight: 64
        });
